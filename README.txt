This repository accompanies an article I have written for Java Magazine. It shows some basic usage of interacting with elasticsearch from a standard Java Application.

The repos contains a reader for the java magazines from the nljug website.
